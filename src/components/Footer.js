    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Leading provider of door-to-door blood testing services in Mumbai. 
              Professional, convenient, and affordable healthcare solutions for all your diagnostic needs.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Menrva Healthcare. All rights reserved.</p>
          <p className="mt-2 text-sm">Professional blood testing services across Mumbai</p>
        </div>
      </div>
    </footer>
  );
